...
namespace CalendarBot.Services
{
    public class AdaptiveCardService : IAdaptiveCardService
    {
        ...
        public AdaptiveCard GetEventCard(Event calendarEvent, string dateTimeFormat)
        {
